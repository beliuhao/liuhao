document.addEventListener("DOMContentLoaded", function() {
  ...
  let instanceOfTooltip = M.Tooltip.init(tooltipEls, {});
  ...
  // pause the carousel when mouse moved in
  ...
  // smooth scrolling to the target when #intro a clicked
  document.querySelector("#intro a").addEventListener("click", function(e) {
    e.preventDefault();
  ...
  // remove .active class from the other a links
  let sidenavLink = document.querySelectorAll(
    "ul#slide-out li:not(#resume):not(#langSwitch) a"
  );
  ...
  window.onscroll = function() {
    ...
    if (prevScrollpos > currentScrollPos) {
      ...
      sideNavMenu.style.top = "0";
    } else {
      fixedNav.style.top = "-65px";
      sideNavMenu.style.top = "-65px";
    }
